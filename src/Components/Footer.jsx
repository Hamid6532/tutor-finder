    ...
    <footer className="bg-teal-700 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1: About */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">Tutor Finder</h3>
            <p className="text-gray-300 mb-4">
              Connecting students and parents with qualified tutors for personalized learning experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Find Tutors</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">Become a Tutor</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-300">How It Works</a></li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">Subscribe to our newsletter for the latest updates and educational resources.</p>
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-teal-500 hover:bg-teal-600 px-4 py-2 rounded-md font-medium transition duration-300"
              >
                Subscribe
              </button>
            </form>
      ...
      <div className="bg-teal-900 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 sm:mb-0">
            &copy; {new Date().getFullYear()} Tutor Finder. All rights reserved.
          </p>
          <div className="flex space-x-6">
            ...
            <a href="#" className="text-gray-400 hover:text-gray-300 text-sm">Contact Us</a>
          </div>
        </div>
      </div>
    </footer>
